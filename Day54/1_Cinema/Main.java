...
*/
    public static void main(String[] args) {
        ...
        System.out.println("아이유님 이름으로 A5로부터 2개의 좌석예약 :" +
                (lotteCinema.reservation("아이유", 'A', 5, 2) ? "예약성공" : "예약실패"));

        System.out.println("제니님 이름으로 C1부터 3개의 좌석 예약 : " +
                (lotteCinema.reservation("제니", 'C', 1, 3) ? "예약성공" : "예약실패"));

        System.out.println("문채원님 이름으로 D4부터 7개의 좌석 예약 : " +
                (lotteCinema.reservation("문채원", 'D', 4, 7) ? "예약성공" : "예약실패"));
        ...
        System.out.println("제니님의 좌석 취소 : 총" +
                lotteCinema.cancel("제니") + "개의 좌석이 취소 되었습니다"));
